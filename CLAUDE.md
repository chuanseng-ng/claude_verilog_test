...
**Current Phase**: Phase 5 (SoC Integration) — ✅ COMPLETE (2026-06-24). M1–M12 done; M11 ASAP7 SoC P&R signed off at **571 MHz / 62.9 mW ⚠️ fabric-only, excludes both hard macros / 520×520 µm / 65.6 % util / 0 DRC / 0 antenna** (run 14, sv2v frontend; PDN = benign tap-cell artifact). Power-attribution root cause + bounds: `docs/PHASE5_RUN_HISTORY.md` §"Power figure caveat" (bead `ew3`). See `docs/PHASE5_RUN_HISTORY.md`.
